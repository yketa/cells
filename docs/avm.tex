...
\STATE{Set $\boldsymbol{f} =$ pair half-edge of previous half-edge of $\boldsymbol{h}$.} \COMMENT[0.4\textwidth]{Thick {\color{blue}blue} half-edge in Fig.~\ref{fig:merge}.}
\STATE{Set $\boldsymbol{t} =$ pair half-edge of next half-edge of $\boldsymbol{h}$.} \COMMENT[0.4\textwidth]{Thin {\color{blue}blue} half-edge in Fig.~\ref{fig:merge}.}
\STATE{Associate $\boldsymbol{f}$ as pair half-edge of $\boldsymbol{t}$ and vice-versa.}
\STATE{Set $\boldsymbol{p} =$ pair half-edge of $\boldsymbol{h}$.} \COMMENT[0.4\textwidth]{Thin {\color{red}red} half-edge in Fig.~\ref{fig:merge}.}
\STATE{Set $\boldsymbol{f} =$ pair half-edge of previous half-edge of $\boldsymbol{p}$.} \COMMENT[0.4\textwidth]{Thick {\color{purple}purple} half-edge in Fig.~\ref{fig:merge}.}
\STATE{Set $\boldsymbol{t} =$ pair half-edge of next half-edge of $\boldsymbol{p}$.} \COMMENT[0.4\textwidth]{Thin {\color{purple}purple} half-edge in Fig.~\ref{fig:merge}.}
\STATE{Associate $\boldsymbol{f}$ as pair half-edge of $\boldsymbol{t}$ and vice-versa.}
...
\STATE{Delete 6 half-edges in the 2 triangles adjacent at $\boldsymbol{h}$ and the vertex $\mu$.}
\end{algorithmic}
\end{algorithm}
