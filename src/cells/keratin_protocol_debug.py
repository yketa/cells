...
parser.add_argument("-p0", type=float, default=3.72,help="dimensionless target perimeter of cell")
 # active forces
parser.add_argument("-taup", type=float, default=1e0,help="persistence time of active force")
# active Brownian force
parser.add_argument("-v0", type=float, default=0.05,help="vertex self-propulsion velocity")
parser.add_argument("-Fpull", type=float, default=0.05,help="outer pulling force")
